...
use crate::zwave_controller_sys;
use crate::zwave_tx_sys;
    ...
    T: Into<Vec<u8>>,
{
    ...
    let tx_options = zwave_tx_sys::zwave_tx_options {
        ...
        transport: zwave_tx_sys::zwave_tx_transport_options {
    ...
    send_data(
        tx_info as zwave_controller_sys::zwave_controller_connection_info_t,
        &bytes,
        tx_options,
        None,
        user,
...
pub fn send_data(
    connection: crate::zwave_controller_sys::zwave_controller_connection_info_t,
    data: &[u8],
    ...
    unsafe {
        zwave_tx_send_data(
            &connection as *const crate::zwave_controller_sys::zwave_controller_connection_info_t,
            data.len() as u16,
            data.as_ptr(),
...
const CONFIG: ZwaveHandlerConfig = ZwaveHandlerConfig {
    minimal_scheme:
    zwave_controller_sys::zwave_controller_encapsulation_scheme_t::ZWAVE_CONTROLLER_ENCAPSULATION_NETWORK_SCHEME,
    ...
    fn new(info: zwave_controller_sys::zwave_controller_connection_info) -> Self {
        unsafe {
            let ep_node = zwave_command_class_get_endpoint_node(
                &info as *const zwave_controller_sys::zwave_controller_connection_info_t,
            );
...
#[zwave_rust_proc_macros_legacy::zwave_command_class(CONFIG)]
#[derive(Default)]
...
impl ZwaveCommandClassFirmwareUpdate {
    ...
    pub fn on_support(
        &self,
        info: zwave_controller_sys::zwave_controller_connection_info_t,
        frame: ZwaveFirmwareUpdateFrame,
    ) -> sl_status_t {
        use ZwaveFirmwareUpdateFrame::*;
